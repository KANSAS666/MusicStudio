...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-4">
            <li class="nav-item">
                <a class="nav-link" href="clientRegistration.php">Регистрация клиента</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="createContract.php">Оформление услуги</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="repetitions.php">График репетиций</a>
            </li>
            <li class="nav-item">
    ...
    <div class="collapse navbar-collapse" id="navbarExample01">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item active">
          <a class="nav-link px-3" href="clientRegistration.php">Регистрация клиента</a>
        </li>
        <li class="nav-item">
          <a class="nav-link px-3" href="createContract.php">Оформление услуги</a>
        </li>
        <li class="nav-item">
          <a class="nav-link px-3" href="repetitions.php">График репетиций</a>
        </li>
        <li class="nav-item active">
